...
Anything you throw in here gets filed. Screenshots, voice memos, business cards, PDFs, half-formed thoughts in a `.md` file, links to articles - drop it in, then say "Hawkeye, process the inbox" (or just "Hi Hawkeye, here's something new").

## How it works

- You drop a file (or paste content into a `.md` file)
- **Hawkeye** routes it to the right specialist (usually **Radar** for capture)
...
- Links to articles for **B.J.** to research deeper
- A quick `.md` braindump at end of day for **Radar** to file across PKM
