...
When Hawkeye dispatches Frank on a task, follow [[SOP-read-own-journal]] before starting. When creating a task, follow [[SOP-create-task]]. When closing a task, follow [[SOP-close-task]] and write a journal entry for any durable insight — especially PA landlord-tenant rules, maintenance failure patterns, or contractor lessons learned.
