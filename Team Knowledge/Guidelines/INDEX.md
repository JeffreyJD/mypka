...
| GL-011 | [[GL-011-capture-watch-summaries-before-session-end]] | Any `/watch` call producing a substantive answer gets captured as a session-log or journal entry before session end — the plugin itself persists nothing (temp files deleted at close). Not conditional on the user saying "remember this." Born 2026-07-09 from Jeff asking whether video knowledge is actually retained. |
