...
- (Felix or another agent finishes UI work and Hawkeye calls Vera before marking the task complete)
...
- [ ] If FAIL, the responsible specialist (usually Felix) is notified via Hawkeye with the report attached.
